...
def plot_track(T1,T2,T3):
    ...
    plt.plot(nr_x,T1, "o-", label="DP", color="blue")
    plt.plot(nr_x,T2,"o-", label="Markov", color ="red")
    plt.plot(nr_x,T3,"o-", label="9D", color="orange")
...
# exclude data of the torunamnet 'World Grand Prix' as there, players have to start their leg with a double field
# Hence, this data would distort our results, since in a standart darts game no one would choose a double field at the beginning of a leg.

DVdB_table19 = pd.read_excel(my_directory + '/Player_specific_tables/vandenBergh19.xlsx')
DVdB_table19 = DVdB_table19[DVdB_table19["Tournament"] != "2019 World Grand Prix"]
DVdB_table20 = pd.read_excel(my_directory + '/Player_specific_tables/vandenBergh20.xlsx')
DVdB_table20 = DVdB_table20[DVdB_table20["Tournament"] != "2020 World Grand Prix"]
DVdB_table21 = pd.read_excel(my_directory + '/Player_specific_tables/vandenBergh21.xlsx')
DVdB_table21 = DVdB_table21[DVdB_table21["Tournament"] != "2021 World Grand Prix"]
AL_table19 = pd.read_excel(my_directory + '/Player_specific_tables/Lewis19.xlsx')
AL_table19 = AL_table19[AL_table19["Tournament"] != "2019 World Grand Prix"]
AL_table20 = pd.read_excel(my_directory + '/Player_specific_tables/Lewis20.xlsx')
AL_table20 = AL_table20[AL_table20["Tournament"] != "2020 World Grand Prix"]
JdS_table20 = pd.read_excel(my_directory + '/Player_specific_tables/deSousa20.xlsx')
JdS_table20 = JdS_table20[JdS_table20["Tournament"] != "2020 World Grand Prix"]
JdS_table21 = pd.read_excel(my_directory + '/Player_specific_tables/deSousa21.xlsx')
JdS_table21 = JdS_table21[JdS_table21["Tournament"] != "2021 World Grand Prix"]
DvD_table20 = pd.read_excel(my_directory + '/Player_specific_tables/vanDuijvenbode20.xlsx')
DvD_table20 = DvD_table20[DvD_table20["Tournament"] != "2020 World Grand Prix"]
DvD_table21 = pd.read_excel(my_directory + '/Player_specific_tables/vanDuijvenbode21.xlsx')
DvD_table21 = DvD_table21[DvD_table21["Tournament"] != "2021 World Grand Prix"]
NA_table18 = pd.read_excel(my_directory + '/Player_specific_tables/Aspinall18.xlsx')
NA_table18 = NA_table18[NA_table18["Tournament"] != "2018 World Grand Prix"]
NA_table19 = pd.read_excel(my_directory + '/Player_specific_tables/Aspinall19.xlsx')
NA_table19 = NA_table19[NA_table19["Tournament"] != "2019 World Grand Prix"]
