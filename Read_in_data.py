...
# =======================================================================
# Import the data set:
os.chdir('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit')
datatable = pd.read_excel('Barthdataextractcopy.xlsx')
datatable.set_index('Index #', inplace=True)

# Remove unnecessary columns i.e. columns with information we don't need for our task e.g. referee:
...
# in the same columns.
# Specifications regarding attempted segments (double, treble, etc) made uniformly for later usage:
...
for z in range(len(datatable.index.tolist())):
    ...
    elif datatable["1st dart attempt (T/S/D/DD/Bull)"].values[z] == "DD":
        datatable["1st dart attempt (T/S/D/DD/Bull)"].values[z] = "D"
    elif datatable["2nd dart attempt (T/S/D/DD/Bull)"].values[z] == "DD":
        datatable["2nd dart attempt (T/S/D/DD/Bull)"].values[z] = "D"
    elif datatable["3rd dart attempt (T/S/D/DD/Bull)"].values[z] == "DD":
        datatable["3rd dart attempt (T/S/D/DD/Bull)"].values[z] = "D"
    elif datatable["1st dart attempt (T/S/D/DD/Bull)"].values[z] == "Bull":
        datatable["1st dart attempt (T/S/D/DD/Bull)"].values[z] = "SB"
    elif datatable["2nd dart attempt (T/S/D/DD/Bull)"].values[z] == "Bull":
        datatable["2nd dart attempt (T/S/D/DD/Bull)"].values[z] = "SB"
    elif datatable["3rd dart attempt (T/S/D/DD/Bull)"].values[z] == "Bull":
...
# ==================================================================================================================
# We also stored those tables:

# DVdB_table19.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/vandenBergh19.xlsx')
# DVdB_table20.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/vandenBergh20.xlsx')
# DVdB_table21.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/vandenBergh21.xlsx')
# AL_table19.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/Lewis19.xlsx')
# AL_table20.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/Lewis20.xlsx')
# JdS_table20.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/deSousa20.xlsx')
# JdS_table21.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/deSousa21.xlsx')
# DvD_table20.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/vanDuijvenbode20.xlsx')
# DvD_table21.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/vanDuijvenbode21.xlsx')
# NA_table19.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/Aspinall19.xlsx')
# NA_table18.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/Aspinall18.xlsx')
# =====================================================================================================================
# =====================================================================================================================
# PRESENTING DATA AS (TR,z,n) combinations
# Introducing dictionary that assigns each field on the board the respective numerical score:
...
# All others are irrelevant because as a professional players have a certain accuracy:
...
# create dictionary that helps iterating throw the table with respect to throw 1/2/3 of a turn:
...
# supportive functions for combi_file:
...
def combi_file(table, num_z, poss_z, attempt_dict, control_d):
    """
    :param table: data(-table) of the player of specific year
    ...
    dic = {}
    combi_list = []
    # Go through throws 1/2/3
    for u in attempt_dict:
        # Go through all turns i.e. each corresponding column
        for cell in range(len(table.index.tolist())):
            # Skip cells that empty (happens when a player only throws one time in a turn)
...
with pd.ExcelWriter('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/'
                    'created_sub_tables/combinations_all players.xlsx') as writer:
...
nr_throws_DVdB_total = len(DVdB_table)
nr_throws_DVdB_19 = len(DVdB_table19)
nr_throws_DVdB_20 = len(DvD_table20)
nr_throws_DVdB_21 = len(DVdB_table21)

nr_throws_AL_total = len(AL_table)
nr_throws_AL_19 = len(AL_table19)
nr_throws_AL_20 = len(AL_table20)

nr_throws_JdS_total = len(JdS_table)
nr_throws_JdS_20 = len(JdS_table20)
nr_throws_JdS_21 = len(JdS_table21)

nr_throws_DvD_total = len(DvD_table)
nr_throws_DvD_20 = len(DvD_table20)
nr_throws_DvD_21 = len(DvD_table21)

nr_throws_NA_total = len(NA_table)
nr_throws_NA_18 = len(NA_table18)
nr_throws_NA_19 = len(NA_table19)
# ---------------------------------------------------------------------------------------------------------------
# How many games a player played (each year):
DVdB_only_column_date = DVdB_table['Date']
AL_only_column_date = AL_table['Date']
JdS_only_column_date = JdS_table['Date']
DvD_only_column_date = DvD_table['Date']
NA_only_column_date = NA_table['Date']
Days_NA_played = NA_only_column_date.drop_duplicates()
Days_DvD_played = DvD_only_column_date.drop_duplicates()
Days_JdS_played = JdS_only_column_date.drop_duplicates()
Days_AL_played = AL_only_column_date.drop_duplicates()
Days_DVdB_played = DVdB_only_column_date.drop_duplicates()

nr_games_DVdB_total = len(Days_DVdB_played)
nr_games_DVdB_19 = len(DVdB_table19["Date"].drop_duplicates())
nr_games_DVdB_20 = len(DVdB_table20["Date"].drop_duplicates())
nr_games_DVdB_21 = len(DVdB_table21["Date"].drop_duplicates())

nr_games_AL_total = len(Days_AL_played)
nr_games_AL_19 = len(AL_table19["Date"].drop_duplicates())
nr_games_AL_20 = len(AL_table20["Date"].drop_duplicates())

nr_games_JdS_total = len(Days_JdS_played)
nr_games_JdS_20 = len(JdS_table20["Date"].drop_duplicates())
nr_games_JdS_21 = len(JdS_table21["Date"].drop_duplicates())

nr_games_DvD_total = len(Days_DvD_played)
nr_games_DvD_20 = len(DvD_table20["Date"].drop_duplicates())
nr_games_DvD_21 = len(DvD_table21["Date"].drop_duplicates())

nr_games_NA_total = len(Days_NA_played)
nr_games_NA_18 = len(NA_table18["Date"].drop_duplicates())
nr_games_NA_19 = len(NA_table19["Date"].drop_duplicates())
# --------------------------------------------------------------------------------------------------------------
...
Avg_score_all_DVdB_19 = (Avg_score_dart1_DVdB_19 + Avg_score_dart2_DVdB_19 + Avg_score_dart3_DVdB_19) / 3
...
Avg_score_all_DVdB_20 = (Avg_score_dart1_DVdB_20 + Avg_score_dart2_DVdB_20 + Avg_score_dart3_DVdB_20) / 3
...
Avg_score_all_DVdB_21 = (Avg_score_dart1_DVdB_21 + Avg_score_dart2_DVdB_21 + Avg_score_dart3_DVdB_21) / 3
...
Avg_score_all_AL_19 = (Avg_score_dart1_AL_19 + Avg_score_dart2_AL_19 + Avg_score_dart3_AL_19) / 3
...
Avg_score_all_AL_20 = (Avg_score_dart1_AL_20 + Avg_score_dart2_AL_20 + Avg_score_dart3_AL_20) / 3
...
Avg_score_all_JdS_20 = (Avg_score_dart1_JdS_20 + Avg_score_dart2_JdS_20 + Avg_score_dart3_JdS_20) / 3
...
Avg_score_all_JdS_21 = (Avg_score_dart1_JdS_21 + Avg_score_dart2_JdS_21 + Avg_score_dart3_JdS_21) / 3
...
Avg_score_all_DvD_20 = (Avg_score_dart1_DvD_20 + Avg_score_dart2_DvD_20 + Avg_score_dart3_DvD_20) / 3
...
Avg_score_all_DvD_21 = (Avg_score_dart1_DvD_21 + Avg_score_dart2_DvD_21 + Avg_score_dart3_DvD_21) / 3
...
Avg_score_all_NA_18 = (Avg_score_dart1_NA_18 + Avg_score_dart2_NA_18 + Avg_score_dart3_NA_18) / 3
...
Avg_score_all_NA_19 = (Avg_score_dart1_NA_19 + Avg_score_dart2_NA_19 + Avg_score_dart3_NA_19) / 3
# -----------------------------------------------------------------------------------------------------------------
...
# information.to_excel('C:/Users/lolbr/Documents/Uni/#Master/#Masterarbeit/created_sub_tables/'
#                     'constructed_information_table.xlsx')
...
# if t == TR:
# pair1 = (TR, t)
# if pair1 not in dic:           #not needed since it would also create TR-combinations for singles or lower triples
# dic[pair1] = 1
# else:
# dic[pair1] = dic[pair1] + 1
